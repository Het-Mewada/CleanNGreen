...
export default function Heading() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center leading-tight md:leading-snug">
        Building a{" "}
        <span 
          ...
          style={{ minWidth: 'fit-content' }} // Prevents layout shift
        >
          {rotatingWords[index]}
        </span>{" "}
